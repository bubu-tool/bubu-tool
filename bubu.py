...
def home():
    ...
    Style.RESET_ALL
    print(Fore.RED + ". uW8\"                     . uW8\"                     " + Style.RESET_ALL)
    print(Fore.RED + "`t888          x.    .     `t888          x.    .     " + Style.RESET_ALL)
    print(Fore.RED + " 8888   .    .@88k  z88u    8888   .    .@88k  z88u   " + Style.RESET_ALL)
    print(Fore.RED + " 9888.z88N  ~\"8888 ^8888    9888.z88N  ~\"8888 ^8888   " + Style.RESET_ALL)
    print(Fore.RED + " 9888  888E   8888  888R    9888  888E   8888  888R   " + Style.RESET_ALL)
    print(Fore.RED + " 9888  888E   8888  888R    9888  888E   8888  888R   " + Style.RESET_ALL)
    print(Fore.RED + " 9888  888E   8888  888R    9888  888E   8888  888R   " + Style.RESET_ALL)
    print(Fore.RED + " 9888  888E   8888 ,888B .  9888  888E   8888 ,888B . " + Style.RESET_ALL)
    print(Fore.RED + ".8888  888\"  \"8888Y 8888\"  .8888  888\"  \"8888Y 8888\"  " + Style.RESET_ALL)
    print(Fore.RED + " `%888*%\"     `Y\"   'YP     `%888*%\"     `Y\"   'YP    " + Style.RESET_ALL)
    print(Fore.RED + "    \"`                         \"`                   " + Style.RESET_ALL)
    print(Fore.YELLOW + "[Ce tool a été développé par bubu]" + Style.RESET_ALL)

    print(f"{Fore.MAGENTA}2. Recherche WHOIS sur un nom de domaine{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}3. Recherche d'informations utilisateur Discord par ID{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}4. OSINT Framework - Outils d'enquête{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}5. Envoyer un message via un webhook Discord{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}6. Générer des codes Nitro Discord{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}7. Générer des tokens Discord{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}8. Trouver le début du token d'un utilisateur Discord par ID{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}9. Rechercher tous les réseaux sociaux associés à un pseudo{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}10. Scanner les port d'une machine{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}11. Token info{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}12. DDoS{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}13. Mail bomber{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}14. Brute force token{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}15. Nitro checker{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}16. Token gen/cracker{Style.RESET_ALL}")
    print(f"{Fore.LIGHTBLACK_EX}17. Quitter{Style.RESET_ALL}")
